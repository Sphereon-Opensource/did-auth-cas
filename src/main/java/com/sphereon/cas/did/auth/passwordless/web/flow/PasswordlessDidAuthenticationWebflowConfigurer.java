...
public class PasswordlessDidAuthenticationWebflowConfigurer extends AbstractCasWebflowConfigurer {
    ...
    protected void doInitialize() {
         ...
         */
        createTransitionForState(viewStateRegister, CasWebflowConstants.TRANSITION_ID_SUBMIT, STATE_ID_PASSWORDLESS_GET_USERID);
        ...
        createTransitionForState(checkResponseState, CasWebflowConstants.TRANSITION_ID_CANCEL, STATE_ID_AUTHENTICATION_FAILED);
